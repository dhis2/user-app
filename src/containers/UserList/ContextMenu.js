...
const ContextMenu = ({ currentUser, user, anchorRef, onClose }) => {
    const {
        access,
                ...
                <FlyoutMenu>
                    ...
                    {access.update && (
                        <MenuItem
                            ...
                            onClick={() => navigateTo(`/users/edit/${user.id}`)}
                            dense
                        />
                    )}
                    {canReplicate && (
                    ...
                    {access.update && disabled && (
                        <MenuItem
                            label={i18n.t('Enable')}
                            icon={<IconCheckmark16 color={colors.grey600} />}
                    ...
                    {access.update && twoFA && (
                        <MenuItem
                            label={i18n.t('Disable Two Factor Authentication')}
